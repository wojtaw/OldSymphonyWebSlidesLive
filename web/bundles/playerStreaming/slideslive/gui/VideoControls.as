package slideslive.gui
{
	...
	public class VideoControls extends MovieClip
	{
		...
		private var viVolumeBar:VolumeBar;
		...
		private function addComponents():void{
			...
			viVolumeBar = new VolumeBar(playerValues);
		...
		private function transformColors(){
			...
			viFull.symbolNormal.transform.colorTransform = newColorTransform;
		...
		private function fullOver(e:MouseEvent){
			viFull.symbolFull.alpha = 1;
			viFull.symbolNormal.alpha = 1;
		...
		private function playOver(e:MouseEvent){
			...
			if(viPlay.symbolPlay.visible) placeToolTip(" Play ",viPlay.x);
			else placeToolTip(" Pause ",viPlay.x);
			toolTipWindow.visible = true;					
		}
		...
		public function showFullscreenState(){
			viFull.symbolNormal.visible = true;
			viFull.symbolNormal2.visible = true;
			viFull.symbolFull.visible = false;
			viFull.symbolFull2.visible = false;
		}
		
		public function showNormalState(){
			viFull.symbolNormal.visible = false;
			viFull.symbolNormal2.visible = false;
			viFull.symbolFull.visible = true;
			viFull.symbolFull2.visible = true;			
		}		
