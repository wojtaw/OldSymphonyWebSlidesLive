...
{	
	...
	public class PresentationController
	{
		...
		private function openBigSldieHandler(e:ControlsEvents):void {
			var path:String = playerValues.getPathToImages()+"original/"+playerValues.getPresentationID()+"/"+playerValues.getSlidesRecords()[currentSlideIndex].getSlideName();
		...
		private function openPresentationOnSlidesLive(e:ControlsEvents):void{
			var path:String = playerValues.getPathToWebsiteWatch()+playerValues.getPresentationID();
			var targetURL:URLRequest = new URLRequest(path);
			navigateToURL(targetURL, "_blank");
		}
