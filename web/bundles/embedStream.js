...
function slidesLiveEmbedBox(){
	...
	this.mediaID = "",
	this.isPaird = false,
	this.playerURL = "http://slideslive.com/SlidesLive_dev/web/bundles/playerStreaming/Player_THC_Streaming.swf",
	...
	this.embedPresentation = function(presentationID, streamID, width, videoSlideRatio, forceLightbox, zoomingOn, startSlide) {
		...
		if(typeof(presentationID)!=='undefined') thisInstance.streamID = streamID;		
	...
	this.createPlayerHtml = function(){
		var flashVarString = "hasVideo="+thisInstance.hasVideo+
							...
							"&sessionID="+thisInstance.presentationID+
							"&streamType=YOUTUBE"+
							"&streamID="+thisInstance.streamID+
