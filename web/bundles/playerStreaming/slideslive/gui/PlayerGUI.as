package slideslive.gui
{
	...
	public class PlayerGUI extends MovieClip
	{
		...
		private var streamLock:StreamLock = new StreamLock();
		...
		public function hideStreamLock() {
			streamLock.visible = false;
		}
		
		public function showStreamLock() {
			streamLock.visible = true;
		}
		...
		private function recalculateStageDimensions():void
		{
			...
			if(playerValues.isEmbedded()) ExternalInterface.call("resizeEmbedBridge", playerValues.playerStageHeight, playerValues.getSessionID());
