...
{
	import slideslive.mediamodule.vimeo.PlayerEvent;
	...
	public class VimeoPlayer extends Sprite {
		...
		{
			//trace("pauseeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee");
			//dispatchEvent(new PlayerEvent(PlayerEvent.FORCE_HIDE));			
			moogaloop.mouseOut();
			moogaloop.pause();
		}
		...
		public function getMooga() : Object {
			return moogaloop;
		}
		...
		{
			trace('readyHandler');
			dispatchEvent(new GeneralEvents(GeneralEvents.VIMEO_SPECIFIC_READY));
		}
